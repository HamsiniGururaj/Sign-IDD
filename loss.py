...
class Loss(nn.Module):
    ...
    def forward(self, preds, targets):
        ...
        preds_masked_length = preds_masked_length * loss_mask[:, :, :75]
        targets_masked_length = targets_masked_length * loss_mask[:, :, :75]
        preds_masked_direct = preds_masked_direct * loss_mask[:, :, :225]
        targets_masked_direct = targets_masked_direct * loss_mask[:, :, :225]
