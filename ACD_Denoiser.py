...
class ACD_Denoiser(nn.Module):
    ...
    def __init__(self,
        ...
        self.trg_embed = nn.Linear(525, hidden_size)
    ...
    def forward(self,
        ...
        o_reshaped = x.view(x.shape[0], x.shape[1], 75, 7)
        o_1, o_2 = torch.split(o_reshaped, [3, 4], dim=-1)
        o_1 = o_1.reshape(o_1.shape[0], o_1.shape[1], 75 * 3)
        o_2 = o_2.reshape(o_2.shape[0], o_2.shape[1], 75 * 4)
